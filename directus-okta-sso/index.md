...
2. **Create App Integration:** In your Okta admin workspace, under the "Applications" tab, select **Create App Integration** and select the desired method (**SAML 2.0** in our case). Click **Next**.
